...
e.g. `Profile low set for this session — sonnet tiers (planning/
authoring stay opus), minimal research, solo leads, medium-effort
reviews. Reset with /wise-profile medium.`
