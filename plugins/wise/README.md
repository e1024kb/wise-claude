...
| `/wise-tickets [<ticket-ref or draft>]` | Restructure an oversized ticket or draft to the canonical ticket shape — the command half of the `wise-tickets` hybrid skill (see [§ Skills](#skills)). |
