...
|---|---|---|
| [`example-workflow`](./workflows/example-workflow/README.md) | `/wise-workflow-run example-workflow` | Reference workflow exercising every v2 step type, two tuning groups, a profile override, an input and a parallel wave. Safe to run. |
