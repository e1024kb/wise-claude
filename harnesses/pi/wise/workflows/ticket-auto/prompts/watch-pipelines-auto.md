...
- Commit each fix via `${WISE_PLUGIN_ROOT}/references/pr/commit-from-fix.md`
...
— read
`${WISE_PLUGIN_ROOT}/workflows/ticket-auto/prompts/handle-bot-reviews-auto.md`
...
Read
`${WISE_PLUGIN_ROOT}/workflows/ticket-auto/prompts/handle-sonar-issues-auto.md`
and follow it end to end with `pr_number`, `pr_url`, `current_branch`,
