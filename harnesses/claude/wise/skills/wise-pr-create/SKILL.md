...
description: >-
  ...
  says "open a PR", "draft the PR body", "update the PR description",
  "push this to review", or types `/wise-pr-create`.
argument-hint: ""
allowed-tools: Read, Write, Bash(git:*), Bash(gh:*), Bash(cat:*), Bash(head:*), Bash(test:*), Bash(cd:*), Bash(bash:*), Bash(ls:*), Bash(date:*), Bash(grep:*), Bash(python3:*), Bash(echo:*), AskUserQuestion
---
