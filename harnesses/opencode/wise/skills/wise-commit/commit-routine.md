...
`${WISE_PLUGIN_ROOT}/references/subject-drafting.md` — the shared
...
- `SIMPLIFY` - `yes` or `no`. Controls whether step 2 runs the
  ...
  `${WISE_PLUGIN_ROOT}/references/simplify-pass.md` — the single
...
`${WISE_PLUGIN_ROOT}/references/simplify-pass.md` — it dispatches the
...
`${WISE_PLUGIN_ROOT}/references/subject-drafting.md` §2.
