...
ordinary local edits and non-destructive shell commands are accepted while
destructive shell commands and mutating external MCP calls remain denied.
...
`gpt-5.6-luna`, `gpt-5.5` (low, medium, high); cursor `inherit`,
