...
<<<<<<<
python3 -c 'import json; print(json.load(open("'"${WISE_PLUGIN_ROOT:-${WISE_DATA_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/wise}/harness/pi}"'/.claude-plugin/plugin.json"))["version"])'
=======
